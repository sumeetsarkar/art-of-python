...
print_arguments3('Sumeet', lname='Sarkar')  # fname recieves 'Sumeet', and kwargs recieve lname
print_arguments3('Sumeet', 'hello', lname='Sarkar') # fname recieves 'Sumeet', args recieve hello and kwargs recieve lname
